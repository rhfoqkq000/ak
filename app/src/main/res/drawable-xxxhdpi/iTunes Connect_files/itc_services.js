        ...
        var services = {
            ...
            time: {
                ...
                getExpiryString: function( timestamp ) {
                    ...
                    var getTimeRemaining = function(endDate, namespace) {
                        ...
                        if (timeDiff <= 0) {
                            //return (l10n['ITC.apps.betaStatus.expired'] +' '+ $filter('date')(timestamp, 'MMM d, y'));
            ...
            roles: {
                ...
                checkCustomerSupport: function(userData) {
                    ...
                    if (userData.permittedActivities.EDIT.indexOf('AppMetadata') >= 0) return false;
                    // Check if user has CS as the only role or if they have CS role coupled with no AppAccess permitted activity, then CS
                    else if (services.roles.hasUserRole(userData, customerSupportRoleString, true) || (services.roles.hasUserRole(userData, customerSupportRoleString) && userData.permittedActivities.EDIT.indexOf('AppMetadata') === -1)) return true;
                    else return false;
                }
            }
