	...
	itcApp.factory('manageUsersService',function($http){
		var myService = {
			...
			getCreateGroupsList: function() {
				return $http.get(global_itc_path + '/ra/users/pre/groups/create',{cache:false}).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			postCreateGroupsList: function(newGroup) {
				return $http.post(global_itc_path + '/ra/users/pre/groups/create',newGroup).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			getEditGroups: function() {
				return $http.get(global_itc_path + '/ra/users/pre/groups/edit',{cache:false}).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			postEditGroups: function(bulkGroups) {
				return $http.post(global_itc_path + '/ra/users/pre/groups/edit',bulkGroups).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			editGroupMembershipStart: function(testers) {
				return $http.post(global_itc_path + '/ra/users/pre/groups/membership',testers).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			editGroupMembershipSave: function(membership) {
				return $http.post(global_itc_path + '/ra/users/pre/groups/membership/save',membership).then(function (response) {
					return response.data;
				}, function(error) { return error; });
			},
			getTesterProfile: function(user) {
				return $http.get(global_itc_path + '/ra/users/pre/'+user+'/profile').then(function(response){
					return response.data;
				}, function(error) { return error; });
			},
			getTesterDetails: function(user) {
				return $http.get(global_itc_path + '/ra/users/pre/'+user+'/details').then(function(response){
					return response.data;
				}, function(error) { return error; });
			},
			saveTesterDetails: function(user,userdetails) {
				return $http.post(global_itc_path + '/ra/users/pre/'+user+'/details',userdetails).then(function(response){
					return response.data;
				}, function(error) { return error; });
			},
			removeTesterFromApp: function(email,adamId,appObject) {
				return $http.post(global_itc_path + '/ra/users/pre/'+email+'/app/'+adamId+'/remove',appObject).then(function(response){
					return response.data;
				}, function(error) { return error; });
			},
