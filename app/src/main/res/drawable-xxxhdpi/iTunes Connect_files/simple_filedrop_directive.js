            ...
            link: function(scope, element, attrs) {
               ...
               /* var isFile = function(item) {
                ...
                zone.on('mouseleave', function(){
                    //added timeout to allow for hover on error popup in case of links in error message.
                    setTimeout(function(){
                        var errorHoverEl = element.find('.errorPopUp.open:hover');
                        if (errorHoverEl.length > 0) {
                            errorEl = element.find('.errorPopUp.open');
                            errorEl.on('mouseleave',function(){
                                errorEl.removeClass('open');
                            });
                        } else {
