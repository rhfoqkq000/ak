...
public class DeveloperActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    @BindView(R.id.toolbar_develop)
    Toolbar toolbar;
    @BindView(R.id.drawer_layout_develop)
    DrawerLayout drawer;
    @BindView(R.id.nav_view_develop)
    ...
    public void onBackPressed() {
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_develop);
